...
<div class="carousel-inner">
  <div class="carousel-item active">
    ...
    <div class="carousel-caption d-none d-md-block">
      <button type="button" class="btn btn-primary btn-lg">Crea tus blogs personales</button>
      <h2 class="fw-bold text-dark">Some representative placeholder content for the first slide.</h2>
    </div>
  </div>
